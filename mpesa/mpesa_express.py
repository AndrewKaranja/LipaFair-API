...
class MpesaExpress(MpesaBaseAuth):
    def __init__(self, env=settings.MPESA_ENV, consumer_key=None, consumer_secret=None):
        super(MpesaExpress, self).__init__(env=env, consumer_key=consumer_key, consumer_secret=consumer_secret)
        self.obtain_auth_token()

    def stk_push(self, business_shortcode=None, lnm_passkey=None, amount=None, callback_url=None,
        ...
        password = "{0}{1}{2}".format(str(business_shortcode), lnm_passkey, time)
